...
<section class="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
    ...
    <div>
        ...
        <p class="text-slate-300 text-lg leading-relaxed mb-8">
            ...
            lalu sinkron ke kalender HP dan Google Calendar.
            Semua pengingat kelas aktif otomatis.
        </p>

        <div class="flex gap-4">
            <a href="/register"
               class="px-8 py-4 rounded-2xl bg-violet-600 hover:bg-violet-700 transition shadow-lg">
                Mulai Gratis
            </a>
        ...
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="bg-slate-800/60 rounded-2xl p-5">
                    ...
                    <h3 class="text-xl font-semibold mt-2">Google Calendar</h3>
                </div>
...
<section class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            <h3 class="text-xl font-bold mb-4">Upload KRS</h3>
            <p class="text-slate-400">
                Upload PDF jadwal kuliah dan sistem membaca otomatis.
            </p>
        </div>

        <div class="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            <h3 class="text-xl font-bold mb-4">Auto Reminder</h3>
            <p class="text-slate-400">
                Jadwal masuk ke kalender dan reminder aktif otomatis.
            </p>
        </div>

        <div class="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            <h3 class="text-xl font-bold mb-4">AI Smart Reader</h3>
            <p class="text-slate-400">
                Gemini membaca KRS walau format kampus berbeda.
            </p>
        </div>
...
<footer class="text-center py-10 text-slate-500 border-t border-white/10 mt-20">
    © {{ date('Y') }} SmartKRS — AI Academic Reminder
</footer>
